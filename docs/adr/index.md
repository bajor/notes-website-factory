...
- [ADR 0005: Preserve low-alpha soft masks as raster](/adr/0005-preserve-low-alpha-soft-masks-as-raster.md) - Accepted. Keep nonzero content lossless when no sample is traceable.
...
- [ADR 0006: Build topic navigation with source-pixel detection and local OCR](/adr/0006-build-time-topic-ocr.md) - Accepted. Detect highlighter frames before vectorization and label them with local Tesseract.
